      ...
      <div className="container about__grid">
        <Reveal className="about__media">
          <div className="about__media-frame">
            <img
              src="https://placehold.co/600x600/10B981/FFFFFF?text=Hermawan+%26+Retno"
        ...
        <div className="about__content">
          ...
          <Reveal delay={80}>
            <h2 className="section-title">
              Tentang Arsarowo Jamur — <em>dedikasi</em> untuk kualitas, sejak 2021.
            </h2>
          </Reveal>
          <Reveal delay={160}>
            <p className="about__text">
              Berawal dari tahun 2021, Bapak Hermawan dan Ibu Retno Ari Purwaningsih
              memulai budidaya jamur tiram di Desa Wisata Bejalen, Kecamatan Ambarawa.
              Kami percaya kualitas jamur yang baik tidak hanya lahir dari bibit unggul,
              melainkan dari ketelitian dan konsistensi perawatan.
            </p>
          </Reveal>
          <Reveal delay={240}>
            <p className="about__text">
              Melalui perpaduan kearifan lokal dan teknik budidaya yang telaten,
              Arsarowo Jamur hadir memenuhi kebutuhan pangan sehat bagi masyarakat
